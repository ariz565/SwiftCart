...
// import { priceAfterDiscount, sortPricesArr } from "@/utils/productUtils";
...
//     <div
//       key={product._id}
//       className={styles.search__body_item}
//       onMouseDown={() => router.push(`/product/${product.slug}?style=0`)}
//       style={{ cursor: "pointer" }}
//     >
//       <div className={styles.search__body_img}>
//         <NextImage src={product.subProducts[0].images[0].url} />
//       </div>
//       <div className={styles.search__body_infos}>
//         <p>{product.name}</p>
//         <p>From ${priceFrom}</p>
//         {product.subProducts[0]?.discount > 0 && (
//           <div className={styles.search__body_sale}>
